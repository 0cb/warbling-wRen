...
p1 <- ggplot()+
      stat_summary(data=df2a, fun=mean, aes(x=DAI, y=LC, group=Code, color=Code), geom="line", linetype="solid", size=2)+#, alpha=0.25)+    #avg on FLC
      ...
      #
      stat_summary(data=df2b, fun=mean, aes(x=DAI, y=LC, group=Code, color=Code), geom="line", linetype="longdash", size=1, alpha=0.50)+    #avg on FLC
      stat_summary(data=df2b, fun=mean, aes(x=DAI, y=LC, group=Code, color=Code), geom="point", alpha=0.50)+
      ...
      #
      labs(title="UCR Bermuda Hybrids vs. Commercial Cultivars", x="Days after irrigation (DAI)", y="Percent coverage (%)")+
      #
      theme(
...
p2 <- ggplot()+
  stat_summary(data=df2a, fun=mean, aes(x=DAI, y=LC, group=Code, color=Code), geom="line", linetype="solid", size=1, alpha=0.50)+    #avg on FLC
  stat_summary(data=df2a, fun=mean, aes(x=DAI, y=LC, group=Code, color=Code), geom="point", alpha=0.50)+
  #stat_summary(data=df2a, fun.data=mean_se, aes(x=DAI, y=LC, group=Code, color=Code), geom="errorbar")+    #SE bars
  #stat_summary(data=df2a, fun.data=mean_se, aes(x=DAI, y=LC, color=Code, label=ifelse(DAI==118, as.character(Code),'')), geom="text", position=position_dodge(width=0, height=4), size=8, hjust=1, vjust=1, show.legend=FALSE)+    #SE bars
  #geom_text_repel(data=df2a, aes(x=DAI, y=LC, label=ifelse(DAI==118, as.character(Code),'')))+
  #
  stat_summary(data=df2b, fun=mean, aes(x=DAI, y=LC, group=Code, color=Code), geom="line", linetype="longdash", size=2)+#, alpha=0.25)+    #avg on FLC
  stat_summary(data=df2b, fun=mean, aes(x=DAI, y=LC, group=Code, color=Code), geom="point")+#, alpha=0.25)+
  #stat_summary(data=df2b, fun.data=mean_se, aes(x=DAI, y=LC, group=Code, color=Code), geom="errorbar", alpha=0.15)+    #SE bars
  #stat_summary(data=df2b, fun.data=mean_se, aes(x=DAI, y=LC, color=Code, label=ifelse(DAI==118, as.character(Code),'')), geom="text", size=8, hjust=1, vjust=1, show.legend=FALSE)+    #SE bars
  #
  labs(title="Commercial Cultivars vs. UCR Bermuda Hybrids", x="Days after irrigation (DAI)", y="Percent coverage (%)")+
  #
  theme(
    panel.grid.major = element_blank(),
    panel.grid.minor = element_blank(),
...
p3 <- ggplot()+
  ...
  #geom_text_repel(data=df2a, aes(x=DAI, y=LC, label=ifelse(DAI==118, as.character(Code),'')))+
  #
  stat_summary(data=df2b, fun=mean, aes(x=DAI, y=nPC2, group=Code, color=Code), geom="line", linetype="longdash", size=1, alpha=0.50)+    #avg on FLC
  stat_summary(data=df2b, fun=mean, aes(x=DAI, y=nPC2, group=Code, color=Code), geom="point", alpha=0.50)+
  #stat_summary(data=df2b, fun.data=mean_se, aes(x=DAI, y=LC, group=Code, color=Code), geom="errorbar", alpha=0.15)+    #SE bars
  #stat_summary(data=df2b, fun.data=mean_se, aes(x=DAI, y=LC, color=Code, label=ifelse(DAI==118, as.character(Code),'')), geom="text", size=8, hjust=1, vjust=1, show.legend=FALSE)+    #SE bars
  #
  labs(title="UCR Bermuda Hybrids vs. Commercial Cultivars (DIA)", x="Days after irrigation (DAI)", y="Percent coverage (%)")+
  #
  theme(
    panel.grid.major = element_blank(),
    panel.grid.minor = element_blank(),
...
p4 <- ggplot()+
  stat_summary(data=df2a, fun=mean, aes(x=DAI, y=nPC2, group=Code, color=Code), geom="line", linetype="solid", size=1, alpha=0.50)+    #avg on FLC
  stat_summary(data=df2a, fun=mean, aes(x=DAI, y=nPC2, group=Code, color=Code), geom="point", alpha=0.50)+
  #stat_summary(data=df2a, fun.data=mean_se, aes(x=DAI, y=LC, group=Code, color=Code), geom="errorbar")+    #SE bars
  #stat_summary(data=df2a, fun.data=mean_se, aes(x=DAI, y=LC, color=Code, label=ifelse(DAI==118, as.character(Code),'')), geom="text", position=position_dodge(width=0, height=4), size=8, hjust=1, vjust=1, show.legend=FALSE)+    #SE bars
  #geom_text_repel(data=df2a, aes(x=DAI, y=LC, label=ifelse(DAI==118, as.character(Code),'')))+
  #
  stat_summary(data=df2b, fun=mean, aes(x=DAI, y=nPC2, group=Code, color=Code), geom="line", linetype="longdash", size=2)+#, alpha=0.25)+    #avg on FLC
  stat_summary(data=df2b, fun=mean, aes(x=DAI, y=nPC2, group=Code, color=Code), geom="point")+#, alpha=0.25)+
  #stat_summary(data=df2b, fun.data=mean_se, aes(x=DAI, y=LC, group=Code, color=Code), geom="errorbar", alpha=0.15)+    #SE bars
  #stat_summary(data=df2b, fun.data=mean_se, aes(x=DAI, y=LC, color=Code, label=ifelse(DAI==118, as.character(Code),'')), geom="text", size=8, hjust=1, vjust=1, show.legend=FALSE)+    #SE bars
  #
  labs(title="Commercial Cultivars vs. UCR Bermuda Hybrids (DIA)", x="Days after irrigation (DAI)", y="Percent coverage (%)")+
  #
  theme(
    panel.grid.major = element_blank(),
    panel.grid.minor = element_blank(),
...
#png("2020_t5vCC_t5.png", height=720, width=720, units="px")
png("2020_t5vCC_t5.png", height=6.3, width=6.5, units="in", res=720)

par(mfrow=c(2,2))

  p1 + coord_cartesian(ylim=c(0.00,130))+
          scale_y_continuous(breaks=seq(0.00,125,25))+
          geom_rect(data=rect, aes(xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax), 
                    color="skyblue1", fill="skyblue1", alpha=0.3, inherit.aes=FALSE)
  
  p2 + coord_cartesian(ylim=c(0.00,130))+
          scale_y_continuous(breaks=seq(0.00,125,25))+
          geom_rect(data=rect, aes(xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax), 
                    color="skyblue1", fill="skyblue1", alpha=0.3, inherit.aes=FALSE)
  
  p3 + coord_cartesian(ylim=c(0.00,130))+
          scale_y_continuous(breaks=seq(0.00,125,25))+
          geom_rect(data=rect, aes(xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax), 
                    color="skyblue1", fill="skyblue1", alpha=0.3, inherit.aes=FALSE)
  
  p4 + coord_cartesian(ylim=c(0.00,130))+
          scale_y_continuous(breaks=seq(0.00,125,25))+
          geom_rect(data=rect, aes(xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax), 
                    color="skyblue1", fill="skyblue1", alpha=0.3, inherit.aes=FALSE)
